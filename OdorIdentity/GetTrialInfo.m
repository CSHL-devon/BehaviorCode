function [TrialInfo] = GetTrialInfo(MaxTrials, pRight, nConcentrations)
...
%Determine which side for go, and assign bank-specific MFC values (each
%bank's MFC needs to be tuned slightly differently to maintain equivalence)
